...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/js/bootstrap.min.js" integrity="sha384-ChfqqxuZUCnJSK3+MXmPNIyE6ZbWh2IMqE241rYiqJxyMiZ6OW/JmZQ5stwEULTy"
    ...
    <nav class="navbar navbar-light bg-white">
        <a href="index.php?page=home" class="navbar-brand">Anti-social</a>
        <div class="menu">
		<ul>
                ...
                <div class="card">
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item">
                            ...
                            <div class="h5"><?php echo $DATA['Gender']; ?></div>
                        </li>
                        <li class="list-group-item">
                            <div class="h6 text-muted">Birthday</div>
                            <div class="h5"><?php echo $DATA['Birthday']; ?></div>
                        </li>
                        <li class="list-group-item">
                            <div class="h6 text-muted">Mobile Phone</div>
                            <div class="h5"><?php echo $DATA['MobilePhone']; ?></div>
                        </li>
                    </ul>
                </div>
            </div>
